-- HOME CONNECT MANAGER - Sample Data with HCM prefix
-- Compatible with hcm_ prefixed tables

-- Demo user profiles
INSERT INTO hcm_user_profiles (id, auth_user_id, email, name, phone, subscription_type) VALUES
...
-- Demo households
INSERT INTO hcm_households (id, owner_id, name, address, currency, timezone) VALUES
...
INSERT INTO hcm_household_members (id, household_id, user_profile_id, name, email, phone, role, login_code, status) VALUES
...
INSERT INTO hcm_task_categories (id, household_id, name, color, icon) VALUES
...
-- Task templates
INSERT INTO hcm_task_templates (id, household_id, name, description, category_id, estimated_duration, instructions, is_public) VALUES
...
-- Demo tasks
INSERT INTO hcm_tasks (id, household_id, title, description, category_id, assigned_to, created_by, status, priority, due_date, estimated_duration, points_reward, requires_photos) VALUES
-- Maison Martin tasks
...
-- Budget categories
INSERT INTO hcm_budget_categories (id, household_id, name, color, icon) VALUES
...
-- Demo budgets
INSERT INTO hcm_budgets (id, household_id, category_id, name, amount, period, start_date, alert_threshold) VALUES
...
-- Demo expenses
INSERT INTO hcm_expenses (id, household_id, category_id, amount, description, vendor, payment_method, recorded_by, expense_date) VALUES
...
-- Demo shopping lists
INSERT INTO hcm_shopping_lists (id, household_id, name, created_by) VALUES
...
INSERT INTO hcm_shopping_list_items (id, list_id, name, quantity, unit, category, estimated_price, is_purchased) VALUES
...
-- Demo recipes
INSERT INTO hcm_recipes (id, household_id, name, description, servings, prep_time, cook_time, difficulty, cuisine_type, dietary_tags, ingredients, instructions, is_public, created_by) VALUES
...
-- Demo meal plans
INSERT INTO hcm_meal_plans (id, household_id, week_start_date, meals, created_by) VALUES
...
-- Demo reports
INSERT INTO hcm_reports (id, household_id, title, description, category, priority, status, location, reported_by, assigned_to, estimated_cost) VALUES
...
-- Demo notifications
INSERT INTO hcm_notifications (household_id, recipient_id, type, title, message, data, is_read) VALUES
...
INSERT INTO hcm_member_points (household_id, member_id, total_points, monthly_points, level, badges, achievements) VALUES
...
-- Sample audit logs
INSERT INTO hcm_audit_logs (household_id, user_id, action, resource_type, resource_id, new_values, ip_address) VALUES
